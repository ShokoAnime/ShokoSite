...
image: "shoko-version-3-7-beta.jpg"
date: "2016-11-07"
anime: "Code Geass"
...
While our primary domain for now is still [jmediamanager.com](https://jmediamanager.org), we suggest updating your bookmarks to our new
domain name [ShokoAnime.com](https://ShokoAnime.com) as we'll be making it the primary domain name very soon. Over the next couple of
