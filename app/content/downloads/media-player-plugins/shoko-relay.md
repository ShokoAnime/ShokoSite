...
name: 'Shoko Relay'
images:
  - url: '/images/downloads/programs-plugins/shokorelay-library.webp'
    alt: 'ShokoRelay - Library'
  - url: '/images/downloads/programs-plugins/shokorelay-series.webp'
    alt: 'ShokoRelay - Series'
  - url: '/images/downloads/programs-plugins/shokorelay-collection.webp'
    alt: 'ShokoRelay - Collection'
  - url: '/images/downloads/programs-plugins/shokorelay-collections.webp'
    alt: 'ShokoRelay - Collections'
  - url: '/images/downloads/programs-plugins/shokorelay-recommended.webp'
