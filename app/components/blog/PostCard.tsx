...
const PostCard = ({ file, image, title, date, description }: PostCardProps) => {
  return (
    <div className="flex w-full flex-col gap-6 md:flex-row 2xl:max-w-[330px] 2xl:flex-col">
      ...
      <div className="flex w-full flex-col justify-center gap-4 text-center md:max-w-[360px] md:text-start lg:max-w-[600px] 2xl:w-full 2xl:flex-col">
        <div>
