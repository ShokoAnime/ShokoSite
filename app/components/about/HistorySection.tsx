...
const HistorySection = ({ title, years, programs, children }: HistorySectionProps) => {
  return (
    <div className="mx-auto mb-16 flex flex-col gap-16 lg:flex-row">
      <div className="flex w-full flex-col items-center gap-6 lg:max-w-[175px]">
      ...
      <div className="flex max-w-[850px] flex-col gap-8 text-center md:text-start">{children}</div>
    </div>
  );
};
