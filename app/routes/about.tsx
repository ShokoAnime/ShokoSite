    ...
    <>
      ...
      <div className="mx-auto min-h-[calc(100vh-644px)] max-w-[1440px] flex-1 py-16">
        {tab === 'The Early Years' && (
          ...
          >
            <div>
              ...
              client allowed AniDB members to easily hash their files for comparison, add them to their AniDB Mylist,
              and update their episode watched status with minimal effort. However, after achieving its initial
              objectives, the development of AniDB Monitor slowed down, and it remained inactive until 2008.
            </div>
            <div>
            ...
            <div>
              Iwerndly, who had been closely following the plugin&apos;s development, stepped in and decided to create
              his own version. Using AniDB Monitor as a base, he began work on his version of the My Anime plugin which
              became available to the public on February 13th, 2008. This marked the beginning of what later evolved
              into the JMM Suite.
            </div>
            <div>
              The plugin&apos;s popularity surged, attracting a growing userbase, along with new feature requests and
              bug reports. Iwerndly consistently worked on updates and improvements, solidifying{' '}
              <strong>My Anime</strong>{' '}
              as the go-to plugin for anime-related media. With continuous development, My Anime 2 was eventually
              launched on June 2nd, 2009, bringing significant enhancements and additions to the growing MediaPortal
              anime community.
            </div>
          </HistorySection>
        )}
        ...
        {tab === 'The JMM Suite' && (
          ...
          >
            <div>
              As My Anime 2 continued to gain popularity, the focus of its development shifted from content consumption
              to collection management as users increasingly desired access to their anime collections outside of
            ...
            <div>
              In parallel to other tasks, the team also launched a project to develop a Web UI for Shoko Server, with
              Elemental Crisis leading the initiative. Avael, a newly onboarded member, was assigned the coding
              responsibilities for the web-based GUI alternative. The team made rapid progress on the Web UI, and within
              a few weeks, a proof of concept was completed.
            </div>
          </HistorySection>
        )}
        ...
        {tab === 'Hello Shoko' && (
          ...
          >
            <div>
              For personal reasons, lwerndly took on a less active role in the project and passed the leadership torch
              to MaxPiva and Elemental Crisis. With the addition of new members, the JMM team tackled larger issues,
              including improving SQLite speed and providing Linux support.
            </div>
            <div>
            ...
            <div>
              ...
              major goal for the team was optimization. Over the next couple of years, Shoko saw vast improvements in
              its speed, database design, and architecture design. Refactoring the now 12+ year old codebase became a
              priority to better resolve bugs and make Shoko more developer-friendly to encourage contribution.
            </div>
            <div>
              ...
              with Elemental Crisis leading the project and selected the same software stack as Shoko Desktop.
            </div>
          </HistorySection>
        )}
        ...
        {tab === 'Modern Shoko' && (
          ...
          >
            <div>
              ...
              Desktop 2 took a backseat as Elemental Crisis and Avael focused on the Server Web UI with development
              picking up again after version 1.00 of the Server Web UI was released.
            </div>
            <div>
            ...
            <div>
              ...
              current Web UI, as well as starting work on a new plugin to support Jellyfin. Revam also contributed to
              this unnamed plugin and eventually became the primary maintainer, overseeing all development on it. As
              development continued, the team decided to name the plugin Shokofin, and it was released towards the end
              of 2021. It quickly became one of the most popular plugins for the Shoko system.
            </div>
            <div>
              In the meantime, the team continued to work on the Web UI, with multiple design revisions made both
              publicly and privately. In mid-2022, a beta version of the new Web UI was publicly released. Development
              on both the plugin and the Web UI continues to this day, with the Shoko team dedicated to improving and
              enhancing their software for their users.
            </div>
          </HistorySection>
        )}
      </div>
