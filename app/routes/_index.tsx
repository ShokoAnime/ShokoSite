      ...
      <div className="container mx-auto pt-16 pb-16">
        <div className="flex gap-[64px] justify-center">
          <div className="flex-col justify-center items-center align-middle">
            <h2>The All-in-One Cross-Platform Anime Management System Built For You</h2>
            <h3>Let Shoko take you to the future</h3>
          ...
          <img src="/images/home/1.png" alt="preview png" width={630} />
        </div>
      </div>
      <div className="bg-[#F5F4F8] w-full h-full pt-16 pb-16">
        <div className="container mx-auto flex flex-col items-center w-full">
          <div>Benefits of Shoko</div>
          <hr className="border-[#EC407A] border-2 w-[100px]" />
          ...
          <div className="grid grid-cols-3 gap-8 w-full mt-16">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div>Has and compare files with AniDB for accurate episode and series identification.</div>
              </div>
            </div>
            <div className="flex gap-4">
              <div>Icon</div>
              <div>
                ...
                <div>Manage multiple, duplicate, and missing files with Shoko's built-in utilities</div>
              </div>
            </div>
            <div className="flex gap-4">
              <div>Icon</div>
              <div>
                ...
                <div>Automatically sync and update watch states for local and supported community sites.</div>
              </div>
            </div>
            <div className="flex gap-4">
              <div>Icon</div>
              <div>
                ...
                <div>Acquire data and images from multiple metadata sites to improve your collections.</div>
              </div>
            </div>
            <div className="flex gap-4">
              <div>Icon</div>
              <div>
                ...
                <div>Integrate with multiple media players for on-the-go access to your collection.</div>
              </div>
            </div>
            <div className="flex gap-4">
              <div>Icon</div>
              <div>
                ...
                <div>Expand Shoko's capabilities, customize it or bring it to an entirely new platform</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto pt-16 pb-16">
        <div className="flex flex-col items-center gap-y-32">
          <div className="flex gap-x-16">
            <div>
              <div>Collection Management Made Easy</div>
              <hr className="border-[#EC407A] border-2 w-[100px]" />
          ...
          <div className="flex gap-x-16">
            ...
            <div>
              <div>Spend More Time Watching Anime</div>
              <hr className="border-[#EC407A] border-2 w-[100px]" />
              <div className="flex gap-8">
                <div className="flex flex-col gap-4">
                  <span>
